...
class ArrayLstAndLinkedLst {
    ...
    public static void main(String[] args) {
         ...
         * add(Element)
         * get(int index) gets elements at the specified index
         ...
         * 
         * 
         * Array list: store elements/nodes sequentially in a single contgious block of
         * memory without any gaps between the nodes
         * 
         * Advantages:
         ...
         * Inefficient Insertions/Deletions: O(n) time complexity for adding or removing
         * elements at arbitrary positions (except at the end).
         * 
         * 
         * 
         * LinkedList stores all elements/nodes in a non-contigious manner meaning they
         * may be gaps between elements/nodes.
         * 
         * Advantages:
         * Efficient Insertions/Deletions: O(1) time complexity for adding or removing
         * elements if the position is known.
         ...
         * Fragmented Storage: Nodes are scattered in memory, potentially affecting
         * cache performance.
         * 
